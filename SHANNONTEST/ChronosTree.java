// $ANTLR 3.4 ChronosTree.g 2012-05-05 17:13:19
...
public class ChronosTree extends TreeFilter {
    ...
    // $ANTLR start "program"
    // ChronosTree.g:46:1: program : ( line )+ ;
    public final void program() throws RecognitionException {
        try {
            // ChronosTree.g:47:2: ( ( line )+ )
            // ChronosTree.g:47:4: ( line )+
            {
            // ChronosTree.g:47:4: ( line )+
            int cnt1=0;
            loop1:
    ...
    // $ANTLR start "line"
    // ChronosTree.g:49:1: line : ( declarator | instantiator | stmt );
    public final void line() throws RecognitionException {
        try {
            // ChronosTree.g:49:5: ( declarator | instantiator | stmt )
            int alt2=3;
            switch ( input.LA(1) ) {
            case DECL:
                {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ChronosTree.g:50:4: instantiator
                    {
    ...
    // ChronosTree.g:53:1: declarator : ^( DECL type_specifier ID ) ;
    public final void declarator() throws RecognitionException {
        ChronosTree.type_specifier_return type_specifier1 =null;


        try {
            // ChronosTree.g:54:2: ( ^( DECL type_specifier ID ) )
            // ChronosTree.g:54:4: ^( DECL type_specifier ID )
            {
    ...
    // ChronosTree.g:59:1: instantiator : ^( INST declarator assignment_expr ) ;
    public final void instantiator() throws RecognitionException {
        try {
            // ChronosTree.g:60:2: ( ^( INST declarator assignment_expr ) )
            // ChronosTree.g:60:4: ^( INST declarator assignment_expr )
            {
    ...
    // $ANTLR start "expr"
    // ChronosTree.g:85:1: expr returns [Value result] : ( assignment_expr | ^( OR expr expr ) | ^( AND expr expr ) | ^( NOT expr ) | ^( EQ expr expr ) | ^( NEQ expr expr ) | ^( GEQ expr expr ) | ^( LEQ expr expr ) | ^( '<' expr expr ) | ^( '>' expr expr ) | ^( '+' expr expr ) | ^( '-' expr expr ) | ^( '*' expr expr ) | ^( '/' expr expr ) | ^( '.' expr expr ) | datetime | timeblock | dayblock | MASTER_T | INT | FLOAT | ID | STRING | TIME );
    public final ChronosTree.expr_return expr() throws RecognitionException {
        ...
        try {
            // ChronosTree.g:87:2: ( assignment_expr | ^( OR expr expr ) | ^( AND expr expr ) | ^( NOT expr ) | ^( EQ expr expr ) | ^( NEQ expr expr ) | ^( GEQ expr expr ) | ^( LEQ expr expr ) | ^( '<' expr expr ) | ^( '>' expr expr ) | ^( '+' expr expr ) | ^( '-' expr expr ) | ^( '*' expr expr ) | ^( '/' expr expr ) | ^( '.' expr expr ) | datetime | timeblock | dayblock | MASTER_T | INT | FLOAT | ID | STRING | TIME )
            int alt7=24;
            switch ( input.LA(1) ) {
            case 61:
                {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ChronosTree.g:89:4: ^( OR expr expr )
                    {
                    ...
                    break;
                case 3 :
                    // ChronosTree.g:90:4: ^( AND expr expr )
                    {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // ChronosTree.g:93:4: ^( EQ expr expr )
                    {
                    ...
                    break;
                case 6 :
                    // ChronosTree.g:94:4: ^( NEQ expr expr )
                    {
                    ...
                    break;
                case 7 :
                    // ChronosTree.g:95:4: ^( GEQ expr expr )
                    {
                    ...
                    break;
                case 8 :
                    // ChronosTree.g:96:4: ^( LEQ expr expr )
                    {
    ...
    // ChronosTree.g:119:1: function returns [Object result] : ^( ID ^( PARAMS ( argument_expr_list )? ) ) ;
    public final Object function() throws RecognitionException {
        ...
        try {
            // ChronosTree.g:121:2: ( ^( ID ^( PARAMS ( argument_expr_list )? ) ) )
            // ChronosTree.g:121:4: ^( ID ^( PARAMS ( argument_expr_list )? ) )
            {
            ...
            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); if (state.failed) return result;
                // ChronosTree.g:121:18: ( argument_expr_list )?
                int alt8=2;
    ...
    // ChronosTree.g:125:1: datetime returns [Datetime result] : ^( DATETIME dayblock timeblock ) ;
    public final Datetime datetime() throws RecognitionException {
        ...
        try {
            // ChronosTree.g:127:2: ( ^( DATETIME dayblock timeblock ) )
            // ChronosTree.g:127:4: ^( DATETIME dayblock timeblock )
            {
    ...
    // ChronosTree.g:131:1: timeblock returns [Timeblock result] : ^( TIMES a= TIME b= TIME ) ;
    public final Timeblock timeblock() throws RecognitionException {
        ...
        try {
            // ChronosTree.g:133:2: ( ^( TIMES a= TIME b= TIME ) )
            // ChronosTree.g:133:4: ^( TIMES a= TIME b= TIME )
            {
    ...
    // ChronosTree.g:137:1: dayblock returns [Dayblock result] : ^( DAYBLOCK_T ( DAY )+ ) ;
    public final Dayblock dayblock() throws RecognitionException {
        ...
        try {
            // ChronosTree.g:140:2: ( ^( DAYBLOCK_T ( DAY )+ ) )
            // ChronosTree.g:140:4: ^( DAYBLOCK_T ( DAY )+ )
            {
            match(input,DAYBLOCK_T,FOLLOW_DAYBLOCK_T_in_dayblock554); if (state.failed) return result;

            match(input, Token.DOWN, null); if (state.failed) return result;
            // ChronosTree.g:140:18: ( DAY )+
            int cnt9=0;
            loop9:
            do {
                int alt9=2;
    ...
    // ChronosTree.g:142:1: argument_expr_list returns [ExprList result] : ( expr )+ ;
    public final ExprList argument_expr_list() throws RecognitionException {
        ...
        ChronosTree.expr_return expr9 =null;
         ...
         result = new ArrayList<String>(); 
        try {
            // ChronosTree.g:144:2: ( ( expr )+ )
            // ChronosTree.g:144:4: ( expr )+
            {
            // ChronosTree.g:144:4: ( expr )+
            int cnt10=0;
            loop10:
    ...
    // ChronosTree.g:146:1: type_specifier : ( INT_T | DOUBLE_T | DAYBLOCK_T | TIME_T | STRING_T | SCHEDULE_T | COURSE_T | COURSELIST_T | TIMEBLOCK_T | DATETIME_T );
    public final ChronosTree.type_specifier_return type_specifier() throws RecognitionException {
        ...
        try {
            // ChronosTree.g:147:2: ( INT_T | DOUBLE_T | DAYBLOCK_T | TIME_T | STRING_T | SCHEDULE_T | COURSE_T | COURSELIST_T | TIMEBLOCK_T | DATETIME_T )
            // ChronosTree.g:
            {
