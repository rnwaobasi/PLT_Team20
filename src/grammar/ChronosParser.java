// $ANTLR 3.4 Chronos.g 2012-05-05 07:44:42
...
public TreeAdaptor getTreeAdaptor() {
    ...
    // $ANTLR start "program"
    // Chronos.g:34:1: program : ( line )+ EOF !;
    public final ChronosParser.program_return program() throws RecognitionException {
        ...
        try {
            // Chronos.g:35:2: ( ( line )+ EOF !)
            // Chronos.g:35:4: ( line )+ EOF !
            {
            ...
            do {
                ...
                if ( (LA1_0==BREAK_T||(LA1_0 >= COURSELIST_T && LA1_0 <= COURSE_T)||LA1_0==DATETIME_T||LA1_0==DAYS_T||LA1_0==DOUBLE_T||(LA1_0 >= FLOAT && LA1_0 <= FOREACH_T)||(LA1_0 >= ID && LA1_0 <= IF_T)||(LA1_0 >= INT && LA1_0 <= INT_T)||LA1_0==MASTER_T||LA1_0==NOT||(LA1_0 >= SCHEDULE_T && LA1_0 <= TIMEBLOCK_T)||LA1_0==TIME_T||LA1_0==51||LA1_0==59||LA1_0==63) ) {
                    alt1=1;
                }
    ...
    // $ANTLR start "line"
    // Chronos.g:37:1: line : ( declarator ';' !| instantiator | stmt );
    public final ChronosParser.line_return line() throws RecognitionException {
        ...
        try {
            // Chronos.g:38:2: ( declarator ';' !| instantiator | stmt )
            int alt2=3;
    ...
    // Chronos.g:42:1: declarator : type_specifier ID -> ^( DECL type_specifier ID ) ;
    public final ChronosParser.declarator_return declarator() throws RecognitionException {
        ...
        try {
            // Chronos.g:44:2: ( type_specifier ID -> ^( DECL type_specifier ID ) )
            // Chronos.g:44:4: type_specifier ID
            {
            ...
            {
                // Chronos.g:45:7: ^( DECL type_specifier ID )
                {
    ...
    // Chronos.g:47:1: instantiator : declarator '=' expr ';' -> ^( INST declarator ^( '=' ID expr ) ) ;
    public final ChronosParser.instantiator_return instantiator() throws RecognitionException {
        ...
        try {
            // Chronos.g:49:2: ( declarator '=' expr ';' -> ^( INST declarator ^( '=' ID expr ) ) )
            // Chronos.g:49:4: declarator '=' expr ';'
            {
            ...
            {
                // Chronos.g:50:7: ^( INST declarator ^( '=' ID expr ) )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // $ANTLR start "stmt"
    // Chronos.g:52:1: stmt : ( expr ';' -> expr | selection_stmt | iteration_stmt | jump_stmt ';' -> jump_stmt | ';' !);
    public final ChronosParser.stmt_return stmt() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_expr=new RewriteRuleSubtreeStream(adaptor,"rule expr");
        try {
            // Chronos.g:52:5: ( expr ';' -> expr | selection_stmt | iteration_stmt | jump_stmt ';' -> jump_stmt | ';' !)
            int alt3=5;
            switch ( input.LA(1) ) {
            case FLOAT:
            case ID:
    ...
    // Chronos.g:58:1: selection_stmt : IF_T expr '{' (a= line )* '}' ( ELSE_T '{' (b= line )* '}' )? -> ^( COND ^( IF_T expr ( $a)* ) ( ^( ELSE_T ( $b)* ) )? ) ;
    public final ChronosParser.selection_stmt_return selection_stmt() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_expr=new RewriteRuleSubtreeStream(adaptor,"rule expr");
        try {
            // Chronos.g:60:2: ( IF_T expr '{' (a= line )* '}' ( ELSE_T '{' (b= line )* '}' )? -> ^( COND ^( IF_T expr ( $a)* ) ( ^( ELSE_T ( $b)* ) )? ) )
            // Chronos.g:60:4: IF_T expr '{' (a= line )* '}' ( ELSE_T '{' (b= line )* '}' )?
            {
            ...
            // Chronos.g:60:17: (a= line )*
            loop4:
            do {
                int alt4=2;
                int LA4_0 = input.LA(1);

                if ( (LA4_0==BREAK_T||(LA4_0 >= COURSELIST_T && LA4_0 <= COURSE_T)||LA4_0==DATETIME_T||LA4_0==DAYS_T||LA4_0==DOUBLE_T||(LA4_0 >= FLOAT && LA4_0 <= FOREACH_T)||(LA4_0 >= ID && LA4_0 <= IF_T)||(LA4_0 >= INT && LA4_0 <= INT_T)||LA4_0==MASTER_T||LA4_0==NOT||(LA4_0 >= SCHEDULE_T && LA4_0 <= TIMEBLOCK_T)||LA4_0==TIME_T||LA4_0==51||LA4_0==59||LA4_0==63) ) {
                    alt4=1;
                }
            ...
            switch (alt6) {
                case 1 :
                    ...
                    // Chronos.g:60:43: (b= line )*
                    loop5:
                    do {
                        int alt5=2;
                        int LA5_0 = input.LA(1);

                        if ( (LA5_0==BREAK_T||(LA5_0 >= COURSELIST_T && LA5_0 <= COURSE_T)||LA5_0==DATETIME_T||LA5_0==DAYS_T||LA5_0==DOUBLE_T||(LA5_0 >= FLOAT && LA5_0 <= FOREACH_T)||(LA5_0 >= ID && LA5_0 <= IF_T)||(LA5_0 >= INT && LA5_0 <= INT_T)||LA5_0==MASTER_T||LA5_0==NOT||(LA5_0 >= SCHEDULE_T && LA5_0 <= TIMEBLOCK_T)||LA5_0==TIME_T||LA5_0==51||LA5_0==59||LA5_0==63) ) {
                            alt5=1;
                        }
            ...
            {
                // Chronos.g:61:7: ^( COND ^( IF_T expr ( $a)* ) ( ^( ELSE_T ( $b)* ) )? )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // Chronos.g:63:1: iteration_stmt : FOREACH_T COURSE_T element= ID IN_T list= ID '{' ( line )* '}' -> ^( FOREACH_T ^( IN_T $element $list) ^( BLOCK ( line )* ) ) ;
    public final ChronosParser.iteration_stmt_return iteration_stmt() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_line=new RewriteRuleSubtreeStream(adaptor,"rule line");
        try {
            // Chronos.g:65:2: ( FOREACH_T COURSE_T element= ID IN_T list= ID '{' ( line )* '}' -> ^( FOREACH_T ^( IN_T $element $list) ^( BLOCK ( line )* ) ) )
            // Chronos.g:65:4: FOREACH_T COURSE_T element= ID IN_T list= ID '{' ( line )* '}'
            {
            ...
            // Chronos.g:65:51: ( line )*
            loop7:
            do {
                int alt7=2;
                int LA7_0 = input.LA(1);

                if ( (LA7_0==BREAK_T||(LA7_0 >= COURSELIST_T && LA7_0 <= COURSE_T)||LA7_0==DATETIME_T||LA7_0==DAYS_T||LA7_0==DOUBLE_T||(LA7_0 >= FLOAT && LA7_0 <= FOREACH_T)||(LA7_0 >= ID && LA7_0 <= IF_T)||(LA7_0 >= INT && LA7_0 <= INT_T)||LA7_0==MASTER_T||LA7_0==NOT||(LA7_0 >= SCHEDULE_T && LA7_0 <= TIMEBLOCK_T)||LA7_0==TIME_T||LA7_0==51||LA7_0==59||LA7_0==63) ) {
                    alt7=1;
                }
            ...
            {
                // Chronos.g:66:7: ^( FOREACH_T ^( IN_T $element $list) ^( BLOCK ( line )* ) )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
                ...
                // Chronos.g:66:19: ^( IN_T $element $list)
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
    ...
    // Chronos.g:68:1: jump_stmt : BREAK_T ;
    public final ChronosParser.jump_stmt_return jump_stmt() throws RecognitionException {
        ...
        try {
            // Chronos.g:70:2: ( BREAK_T )
            // Chronos.g:70:4: BREAK_T
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "expr"
    // Chronos.g:72:1: expr : ( and_expr ( OR ^ and_expr )* | assignment_expr );
    public final ChronosParser.expr_return expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:74:2: ( and_expr ( OR ^ and_expr )* | assignment_expr )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // Chronos.g:74:4: and_expr ( OR ^ and_expr )*
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // Chronos.g:75:4: assignment_expr
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // Chronos.g:77:1: assignment_expr : ID '=' ^ expr ;
    public final ChronosParser.assignment_expr_return assignment_expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:79:2: ( ID '=' ^ expr )
            // Chronos.g:79:4: ID '=' ^ expr
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // Chronos.g:81:1: and_expr : equiv_expr ( AND ^ equiv_expr )* ;
    public final ChronosParser.and_expr_return and_expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:83:2: ( equiv_expr ( AND ^ equiv_expr )* )
            // Chronos.g:83:4: equiv_expr ( AND ^ equiv_expr )*
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // Chronos.g:83:15: ( AND ^ equiv_expr )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // Chronos.g:83:16: AND ^ equiv_expr
            	    {
    ...
    // Chronos.g:85:1: equiv_expr : rel_expr ( ( EQ ^| NEQ ^) rel_expr )* ;
    public final ChronosParser.equiv_expr_return equiv_expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:87:2: ( rel_expr ( ( EQ ^| NEQ ^) rel_expr )* )
            // Chronos.g:87:4: rel_expr ( ( EQ ^| NEQ ^) rel_expr )*
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // Chronos.g:87:13: ( ( EQ ^| NEQ ^) rel_expr )*
            loop12:
            do {
                int alt12=2;
                ...
                switch (alt12) {
            	case 1 :
            	    // Chronos.g:87:15: ( EQ ^| NEQ ^) rel_expr
            	    {
            	    // Chronos.g:87:15: ( EQ ^| NEQ ^)
            	    int alt11=2;
    ...
    // Chronos.g:89:1: rel_expr : ( math_expr ( ( '<' ^| '>' ^| GEQ ^| LEQ ^) math_expr )* | datetime );
    public final ChronosParser.rel_expr_return rel_expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:91:2: ( math_expr ( ( '<' ^| '>' ^| GEQ ^| LEQ ^) math_expr )* | datetime )
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // Chronos.g:91:4: math_expr ( ( '<' ^| '>' ^| GEQ ^| LEQ ^) math_expr )*
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    // Chronos.g:91:14: ( ( '<' ^| '>' ^| GEQ ^| LEQ ^) math_expr )*
                    loop14:
                    do {
                        int alt14=2;
                        ...
                        switch (alt14) {
                    	case 1 :
                    	    // Chronos.g:91:16: ( '<' ^| '>' ^| GEQ ^| LEQ ^) math_expr
                    	    {
                    	    // Chronos.g:91:16: ( '<' ^| '>' ^| GEQ ^| LEQ ^)
                    	    int alt13=4;
                    	    switch ( input.LA(1) ) {
                    	    case 60:
                    	        {
    ...
    // Chronos.g:94:1: math_expr : math_term ( ( '+' ^| '-' ^) math_term )* ;
    public final ChronosParser.math_expr_return math_expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:96:2: ( math_term ( ( '+' ^| '-' ^) math_term )* )
            // Chronos.g:96:4: math_term ( ( '+' ^| '-' ^) math_term )*
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // Chronos.g:98:1: math_term : ( unary_expr ( ( '*' ^| '/' ^) unary_expr )* | timeblock );
    public final ChronosParser.math_term_return math_term() throws RecognitionException {
        ...
        try {
            // Chronos.g:100:2: ( unary_expr ( ( '*' ^| '/' ^) unary_expr )* | timeblock )
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // Chronos.g:100:4: unary_expr ( ( '*' ^| '/' ^) unary_expr )*
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // Chronos.g:103:1: unary_expr : ( postfix_expr ( '.' ^ postfix_expr )* | NOT ^ postfix_expr );
    public final ChronosParser.unary_expr_return unary_expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:104:2: ( postfix_expr ( '.' ^ postfix_expr )* | NOT ^ postfix_expr )
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // Chronos.g:104:4: postfix_expr ( '.' ^ postfix_expr )*
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // Chronos.g:105:4: NOT ^ postfix_expr
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // Chronos.g:107:1: postfix_expr : ( function | primary_expr );
    public final ChronosParser.postfix_expr_return postfix_expr() throws RecognitionException {
        ...
        try {
            // Chronos.g:109:2: ( function | primary_expr )
            int alt23=2;
    ...
    // Chronos.g:113:1: function : ID '(' ( argument_expr_list )? ')' -> ^( ID ^( PARAMS ( argument_expr_list )? ) ) ;
    public final ChronosParser.function_return function() throws RecognitionException {
        ...
        try {
            // Chronos.g:114:2: ( ID '(' ( argument_expr_list )? ')' -> ^( ID ^( PARAMS ( argument_expr_list )? ) ) )
            // Chronos.g:114:4: ID '(' ( argument_expr_list )? ')'
            {
            ...
            // Chronos.g:114:11: ( argument_expr_list )?
            int alt24=2;
            ...
            {
                // Chronos.g:115:6: ^( ID ^( PARAMS ( argument_expr_list )? ) )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
                stream_ID.nextNode()
                ...
                // Chronos.g:115:11: ^( PARAMS ( argument_expr_list )? )
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
                ...
                // Chronos.g:115:20: ( argument_expr_list )?
    ...
    // Chronos.g:122:1: datetime : dayblock timeblock -> ^( DATETIME dayblock timeblock ) ;
    public final ChronosParser.datetime_return datetime() throws RecognitionException {
        ...
        try {
            // Chronos.g:124:2: ( dayblock timeblock -> ^( DATETIME dayblock timeblock ) )
            // Chronos.g:124:4: dayblock timeblock
            {
            ...
            {
                // Chronos.g:125:7: ^( DATETIME dayblock timeblock )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // Chronos.g:127:1: timeblock : a= TIME '~' b= TIME -> ^( TIMES $a $b) ;
    public final ChronosParser.timeblock_return timeblock() throws RecognitionException {
        ...
        try {
            // Chronos.g:129:2: (a= TIME '~' b= TIME -> ^( TIMES $a $b) )
            // Chronos.g:129:4: a= TIME '~' b= TIME
            {
    ...
    // Chronos.g:131:1: dayblock : '[' DAY ( ',' DAY )* ']' -> ^( DAYS ( DAY )+ ) ;
    public final ChronosParser.dayblock_return dayblock() throws RecognitionException {
        ...
        try {
            // Chronos.g:133:2: ( '[' DAY ( ',' DAY )* ']' -> ^( DAYS ( DAY )+ ) )
            // Chronos.g:133:4: '[' DAY ( ',' DAY )* ']'
            {
    ...
    // Chronos.g:135:1: primary_expr : ( INT | FLOAT | ID | STRING | TIME | MASTER_T | '(' expr ')' -> expr );
    public final ChronosParser.primary_expr_return primary_expr() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_expr=new RewriteRuleSubtreeStream(adaptor,"rule expr");
        try {
            // Chronos.g:136:2: ( INT | FLOAT | ID | STRING | TIME | MASTER_T | '(' expr ')' -> expr )
            int alt26=7;
            switch ( input.LA(1) ) {
            case INT:
                {
    ...
    // Chronos.g:144:1: argument_expr_list : ( expr ) ( ',' expr )* -> ( expr )+ ;
    public final ChronosParser.argument_expr_list_return argument_expr_list() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_expr=new RewriteRuleSubtreeStream(adaptor,"rule expr");
        try {
            // Chronos.g:145:2: ( ( expr ) ( ',' expr )* -> ( expr )+ )
            // Chronos.g:145:4: ( expr ) ( ',' expr )*
            {
            // Chronos.g:145:4: ( expr )
            // Chronos.g:145:5: expr
            {
    ...
    // Chronos.g:147:1: type_specifier : ( INT_T | DOUBLE_T | DAYS_T | TIME_T | STRING_T | SCHEDULE_T | COURSE_T | COURSELIST_T | TIMEBLOCK_T | DATETIME_T );
    public final ChronosParser.type_specifier_return type_specifier() throws RecognitionException {
        ...
        try {
            // Chronos.g:148:2: ( INT_T | DOUBLE_T | DAYS_T | TIME_T | STRING_T | SCHEDULE_T | COURSE_T | COURSELIST_T | TIMEBLOCK_T | DATETIME_T )
            // Chronos.g:
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    public static final BitSet FOLLOW_line_in_program110 = new BitSet(new long[]{0x88097C49B1852C40L});
    ...
    public static final BitSet FOLLOW_65_in_selection_stmt253 = new BitSet(new long[]{0x88097C49B1852C40L,0x0000000000000004L});
    public static final BitSet FOLLOW_line_in_selection_stmt257 = new BitSet(new long[]{0x88097C49B1852C40L,0x0000000000000004L});
    ...
    public static final BitSet FOLLOW_65_in_selection_stmt266 = new BitSet(new long[]{0x88097C49B1852C40L,0x0000000000000004L});
    public static final BitSet FOLLOW_line_in_selection_stmt271 = new BitSet(new long[]{0x88097C49B1852C40L,0x0000000000000004L});
    ...
    public static final BitSet FOLLOW_65_in_iteration_stmt331 = new BitSet(new long[]{0x88097C49B1852C40L,0x0000000000000004L});
    public static final BitSet FOLLOW_line_in_iteration_stmt333 = new BitSet(new long[]{0x88097C49B1852C40L,0x0000000000000004L});
